...
/**
 * 首页（FE-006 / FE-007 / FE-008 / FE-009 / FE-010 / FE-011）。
 *
 * 桌面端组合（FrontendDesign.md §18.1）：
 * - Hero：主信息 + 快捷入口（左），校园轮播（右）；
 * - 主栏：即将截止 + 热门竞赛 + 社区（正在组队 / 正在招新的组织 / 近期活动）；
 * - 右侧栏：通知公告 + 热门指南 + 常见问题。
 *
 * Phone / Tablet 采用单列堆叠，社区与右侧栏在内容之后展开（§18.2 / §34）。
 */
</script>
