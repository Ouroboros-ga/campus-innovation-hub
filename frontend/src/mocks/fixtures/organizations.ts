...
export const organizationDetails: OrganizationDetail[] = [
  {
    ...
    advisorName: '王丽华',
    advisorTitle: '教授',
    advisorCollege: '人工智能学院',
    advisorResearch: '机器学习、自然语言处理',
    leaderName: '张同学',
    leaderTitle: '会长',
    leaderGrade: '2023级',
  ...
  },
  {
    ...
    advisorName: '孙老师',
    advisorTitle: '讲师',
    advisorCollege: '教学科研办',
    advisorResearch: '学生科创与就业服务',
    leaderName: '李同学',
    leaderTitle: '部长',
    leaderGrade: '2023级',
