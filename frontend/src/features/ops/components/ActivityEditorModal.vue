...
<template>
  <UModal
    :open="props.open"
    :ui="{ content: 'max-w-5xl w-[calc(100vw-1rem)] sm:w-[calc(100vw-2rem)] max-h-[90vh] flex flex-col overflow-hidden', header: 'shrink-0 border-b border-default', body: 'flex-1 overflow-y-auto min-h-0 p-4 sm:p-6', footer: 'shrink-0 border-t border-default bg-muted/20' }"
    @update:open="close"
  >
    <template #header>
