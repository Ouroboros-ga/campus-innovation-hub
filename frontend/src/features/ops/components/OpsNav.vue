...
<template>
  ...
  >
    ...
    <div>
      ...
      >
        <RouterLink
          :to="{ name: 'ops-homepage' }"
          class="flex items-center gap-2 rounded-md px-2.5 py-1.5 text-sm"
          :class="isActive('ops-homepage') ? 'bg-primary-50 font-medium text-primary-700 dark:bg-primary-950 dark:text-primary-300' : 'text-muted hover:bg-muted hover:text-highlighted'"
        >
          <UIcon
            name="i-lucide-home"
            class="size-3.5"
