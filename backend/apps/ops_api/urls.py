...
from apps.ops_api import activity_views, agent_views, analytics_views, competition_views, consultation_views, content_views, homepage_views, media_views, organization_views, overview_views, recruitment_views, team_views
...
urlpatterns = [
    ...
    path("ops/documents", content_views.SiteDocumentCollectionView.as_view(), name="ops-document-collection"),
    path("ops/documents/<str:object_id>", content_views.SiteDocumentDetailView.as_view(), name="ops-document-detail"),
    path("ops/documents/<str:object_id>/publish", content_views.SiteDocumentPublishView.as_view(), name="ops-document-publish"),
    path("ops/documents/<str:object_id>/archive", content_views.SiteDocumentArchiveView.as_view(), name="ops-document-archive"),
    ...
    path("ops/media/upload", media_views.OpsMediaUploadView.as_view(), name="ops-media-upload"),
    ...
    path("ops/organizations/<str:object_id>", organization_views.OrganizationDetailView.as_view(), name="ops-organization-detail"),
    path("ops/users/search", organization_views.OpsUserSearchView.as_view(), name="ops-user-search"),
